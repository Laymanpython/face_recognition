...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_root", type=str, default='/home/dell/Desktop/AdaFace-master/data/ijb/IJBB')
    ...
    save_root = './result/IJBB/{}'.format(args.model_name)
    ...
    for partition_idx in tqdm(range(num_partition)):
        ...
        if args.save_features:
            save_path = os.path.join(save_root,
                                     'feature_extracted/ijbb_pred_{}_{}.npy'.format(args.model_name, partition_idx))
        ...
        if len(norms) > 0:
            ...
            if args.save_features:
                save_path = os.path.join(save_root, 'feature_extracted/ijbb_pred_{}_norm_{}.npy'.format(args.model_name,
                                                                                                        partition_idx))
