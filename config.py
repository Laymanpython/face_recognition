...
def get_args():
    ...
    parent_parser.add_argument('--data_root', type=str, default='/home/dell/Desktop/AdaFace-master/data/')
    parent_parser.add_argument('--train_data_path', type=str, default='umd')
    parent_parser.add_argument('--val_data_path', type=str, default='umd')
    ...
    parent_parser.add_argument('--batch_size', default=128, type=int,
                               help='mini-batch size (default: 256), this is the total '
                                    'batch size of all GPUs on the current node when '
                                    'using Data Parallel or Distributed Data Parallel')

    parent_parser.add_argument('--lr', help='learning rate', default=2e-1, type=float)
    parent_parser.add_argument('--lr_milestones', default='4,8,12,14', type=str, help='epochs for reducing LR')
    ...
    parent_parser.add_argument('--use_wandb', action='store_true',default=True)
...
def add_task_arguments(parser):
    parser.add_argument('--arch', default='mobilefacenet')
